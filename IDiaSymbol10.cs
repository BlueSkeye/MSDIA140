...
namespace MSDIA140
{
	...
	public interface IDiaSymbol10 : IDiaSymbol9
	{
		[DispId(0)]
		new uint symIndexId
		{
		...
		[DispId(227)]
		new uint associatedSymbolSection
		{
			[MethodImpl(MethodImplOptions.InternalCall)]
			get;
		}
		...
		[DispId(228)]
		new uint associatedSymbolOffset
		{
			[MethodImpl(MethodImplOptions.InternalCall)]
			get;
		}
		...
		[DispId(230)]
		new ulong associatedSymbolAddr
		{
			[MethodImpl(MethodImplOptions.InternalCall)]
			get;
		}
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		void get_sourceLink([In] uint cb, out uint pcb, out byte pb);
	}
}
